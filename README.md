![Maruyama Aya](https://static.zerochan.net/Maruyama.Aya.full.2298233.png)
# Maruyama Aya Robot
...
Originally a marie fork - Maruyama Aya has evolved further and was built to be more useful for Anime Chats. 

Can be found on telegram as [Maruyama Aya](https://t.me/MaruyamaAya_bot).

The Support group can be reached out to at [Inime Support](https://t.me/inime), where you can ask for help setting up your bot, discover/request new features, report bugs, and stay in the loop whenever a new update is available. 

News channel as at [Saitama Robot Updates](https://t.me/OnePunchUpdates) 
...
<details>
 ...
 Note: This instruction set is just a copy paste from marie, note that [Inime](https://t.me/Inime) aims to handle support for @SaitamaRobot and now how to setup your own fork, if you find this bit confusing/tough to understand then we recommend you ask a dev, kindly avoid asking how to setup the bot instance in the support chat, it aims to help our own instance of the bot. 
...
For queries or any issues regarding the bot please open an issue ticket or visit us at [Inime Support](https://t.me/inime)
## How to setup on Heroku 
For starters click on this button


[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/NobArxtx/MaruyamaAya_bot.git)
